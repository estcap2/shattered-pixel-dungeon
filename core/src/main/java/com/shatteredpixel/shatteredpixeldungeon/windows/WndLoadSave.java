...
public class WndLoadSave extends Window {
	...
	public WndLoadSave(final int slot){
		...
		RedButton erase = new RedButton( Messages.get(this, "erase")){
			...
			protected void onClick() {
				...
				ShatteredPixelDungeon.scene().add(new WndOptions(
						Messages.get(WndLoadSave.class, "erase_warn_title"),
						Messages.get(WndLoadSave.class, "erase_warn_body"),
						Messages.get(WndLoadSave.class, "erase_warn_yes"),
						Messages.get(WndLoadSave.class, "erase_warn_no") ) {
					@Override
